...
function attachEventListeners() {
  ...
  waitListForm?.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      const url = new URL('https://script.google.com/macros/s/AKfycbz0pHDLMt5c8BDaqNyeHDkcsD5qO_A480is38B_q_MEmX_1-RVIBVRC2f8nfzJYsOgsIw/exec');
      ...
      if (response.ok) {
        ...
        popup.querySelector('.card-image').innerHTML = `
          <div class="success-message">
            <p style="font-size: 0.7em;">Thanks for joining our wait-list!<br>Our team will review your application and get back to you soon.</p>
          </div>
        `;
